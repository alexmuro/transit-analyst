...
var parseAgent = function(agent,house, client){
    ...
    query.on('error', function(err) {
        console.log("fadaafdas");
        throw new Error('error running query: ' + query + " " + err);
    });
    ...
    //console.log("gtfsdb-load --database_url"  + " " +conString +" --is_geospatial "+destinationStream);
    /*var child = exec("gtfsdb-load --database_url "+conString+" --is_geospatial "+destinationStream +
            " --schema " + schemaName,
